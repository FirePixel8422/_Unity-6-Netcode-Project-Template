...
public class NetworkCursorHandler : MonoBehaviour
{
    ...
    public void Init(Color cursorColor, bool owner)
    {
        ...
        {
            img.enabled = false;
            CallbackScheduler.RegisterCallback(OnUpdateOwner, CallbackType.Update);
        }
        else
        {
            img.enabled = true;
            CallbackScheduler.RegisterCallback(OnUpdateNonOwner, CallbackType.Update);
        }
    }
    ...
    {
        CallbackScheduler.UnRegisterCallback(OnUpdateOwner, CallbackType.Update);
        CallbackScheduler.UnRegisterCallback(OnUpdateNonOwner, CallbackType.Update);
    }
}